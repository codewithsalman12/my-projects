  ...
  const cars = [
    {
      ...
      price: 45,
      seats: 5,
      img: "src/assets/carimages/honda1.webp",
      ...
      price: 45,
      seats: 5,
      img: "src/assets/carimages/car2.jpg",
      ...
      price: 45,
      seats: 5,
      img: "src/assets/carimages/car3.avif",
      ...
      price: 45,
      seats: 5,
      img: "src/assets/carimages/car4.png",
    ...
    },
    {
      ...
      price: 120,
      seats: 5,
      img: "src/assets/carimages/car5.webp",
    ...
    },
    {
      ...
      price: 80,
      seats: 3,
      img: "src/assets/carimages/car6.jpg",
  ...
  const bikes = [
    {
      ...
      title: "CB125",
      price: 25,
      img: "src/assets/bikeimages/CB125.jpg",
    ...
    },
    {
      ...
      title: "CG150",
      price: 30,
      img: "src/assets/bikeimages/CG150.jpg",
      ...
      title: "CB350RS",
      price: 35,
      img: "src/assets/bikeimages/Honda CB350RS.jpg",
      ...
      title: "HONDA AX-",
      price: 30,
      img: "src/assets/bikeimages/HONDA_AX-.jpg",
      ...
      title: "CG 125",
      price: 20,
      img: "src/assets/bikeimages/CG125.jpg",
      desc: "Sporty, agile, and reliable — for enthusiasts.",
    },
      {
      id: "bike-6",
      title: "Honda NX200",
      price: 36,
      img: "src/assets/bikeimages/Honda NX200.avif",
  ...
  const houses = [
    {
      ...
      price: 90,
      img: "src/assets/houseimages/cozy 2br appartment.jpg",
    ...
    },
    {
      ...
      title: "Luxury Villa",
      price: 320,
      img: "src/assets/houseimages/luxury villa.jpg",
    ...
    },
     {
      ...
      price: 90,
      img: "src/assets/houseimages/modern-2.jpg",
    ...
    },
    {
      ...
      price: 320,
      img: "src/assets/houseimages/costal range.jpeg",
    ...
    },
     {
      ...
      price: 350,
      img: "src/assets/houseimages/ultra.jpg",
    ...
    },
    {
      ...
      price: 220,
      img: "src/assets/houseimages/mountain.jpeg",
          ...
          <section className="grid gap-8 md:grid-cols-2 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-700 hover:scale-[1.02]">
                <img
                  src="src/assets/houseimages/luxury villa.jpg"
                  alt="luxury car"
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-lg overflow-hidden shadow transition transform hover:scale-105">
                  <img
                    src="src/assets/carimages/car5.webp"
                    alt="premium"
                ...
                <div className="rounded-lg overflow-hidden shadow transition transform hover:scale-105">
                  <img
                    src="src/assets/bikeimages/Honda NX200.avif"
                    alt="villa"
                    className="w-full h-36 object-cover"
                  />
                </div>
